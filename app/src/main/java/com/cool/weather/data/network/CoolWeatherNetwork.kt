package com.cool.weather.data.network

import com.cool.weather.data.network.api.PlaceService
import com.cool.weather.data.network.api.WeatherService
...
class CoolWeatherNetwork {
    ...
    companion object {
        ...
        fun getInstance() = network ?: synchronized(CoolWeatherNetwork::class.java) {
