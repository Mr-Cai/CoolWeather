package com.cool.weather.ui.weather
...
import com.cool.weather.databinding.ActivityWeatherBinding
...
class WeatherActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.weatherId = when {
            viewModel.isWeatherCached() -> viewModel.getCachedWeather().basic.weatherId
