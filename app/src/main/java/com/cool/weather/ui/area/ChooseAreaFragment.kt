...
import com.cool.weather.databinding.ChooseAreaBindingImpl
import com.cool.weather.ui.MainActivity
...
class ChooseAreaFragment : Fragment() {
    ...
    private val viewModel by lazy {
        ViewModelProviders.of(this, InjectorUtil.getChooseAreaModelFactory()).get(ChooseAreaViewModel::class.java)
    }
